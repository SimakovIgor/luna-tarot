...
public class ClaudeHoroscopeGenerator implements HoroscopeGenerator {
    ...
    private static String buildSystemPrompt(UserEntity user) {
        return """
            ...
            СОДЕРЖАНИЕ — ОДИН компактный абзац, 3–4 предложения, всего
            ~300–400 знаков. Не дроби на «утро / день / вечер», не пиши
            каталог энергий и стихий:
            • Один образ дня (метафора) — что в этом дне для тебя.
            • Что заметить, услышать, на что обратить внимание сегодня.
            • Один конкретный ракурс или мягкий шаг внимания.
