...
public class ClaudeHoroscopeGenerator implements HoroscopeGenerator {
    ...
    private static String buildSystemPrompt(UserEntity user) {
        return """
            ...
            СОДЕРЖАНИЕ — ОДИН компактный абзац, 2–3 предложения, всего ~250 знаков:
            • Один образ дня (метафора, не каталог энергий) + один конкретный
              ракурс или шаг.
            • Без перечислений «утром / днём / вечером», без длинного развёрнутого
              разбора энергий и стихий. Это короткий шёпот Луны, а не лекция.
